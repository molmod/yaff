...
project = u'Yaff'
copyright = u'2011, Toon Verstraelen, Louis Vanduyfhuys'
...
with open('../yaff/version.py', 'r') as fh:
...
htmlhelp_basename = 'YaffDocumentation'
...
latex_documents = [
  ('index', 'yaff_documentation.tex', u'Yaff Documentation',
